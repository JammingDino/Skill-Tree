...
public record SkillEffectType<T extends SkillEffect>(Function<JsonObject, T> factory) {
    ...
    private static final Map<ResourceLocation, SkillEffectType<?>> REGISTRY = new HashMap<>();
     ...
     */
    public static <T extends SkillEffect> void register(ResourceLocation id, Function<JsonObject, T> factory) {
    ...
    public static void registerAll() {
        ...
        register(new ResourceLocation(Jd_skill_tree.MOD_ID, "attribute"), AttributeSkillEffect::fromJson);
        register(new ResourceLocation(Jd_skill_tree.MOD_ID, "mining_speed"), MiningSpeedSkillEffect::fromJson);
        register(new ResourceLocation(Jd_skill_tree.MOD_ID, "potion"), PotionSkillEffect::fromJson);
        register(new ResourceLocation(Jd_skill_tree.MOD_ID, "enchantment"), EnchantmentSkillEffect::fromJson);
        register(new ResourceLocation(Jd_skill_tree.MOD_ID, "attack_knockback"), AttackKnockbackSkillEffect::fromJson);
        register(new ResourceLocation(Jd_skill_tree.MOD_ID, "experience"), ExperienceSkillEffect::fromJson);
        register(new ResourceLocation(Jd_skill_tree.MOD_ID, "swim_speed"), SwimSpeedSkillEffect::fromJson);
        register(new ResourceLocation(Jd_skill_tree.MOD_ID, "lava_speed"), LavaSpeedSkillEffect::fromJson);
        register(new ResourceLocation(Jd_skill_tree.MOD_ID, "effect_immunity"), EffectImmunitySkillEffect::fromJson);
        register(new ResourceLocation(Jd_skill_tree.MOD_ID, "creative_flight"), CreativeFlightSkillEffect::fromJson);
        register(new ResourceLocation(Jd_skill_tree.MOD_ID, "elytra"), ElytraSkillEffect::fromJson);
    }
}